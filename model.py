...
filename = 'Train_Description_Path' + 'Flickr_8k.trainImages.txt'
...
# photo features
train_features = load_photo_features('processed_data/features.pkl', train)
...
model.fit_generator(data_generator(train_descriptions, train_features, wordtoix, max_length, num_photos_per_batch),
...
# load test set
filename = 'C:/Users/Harsh/PycharmProjects/image-captioning/image-captioning/Flickr8k_text/Flickr_8k.devImages.txt'
